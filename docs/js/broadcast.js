(() => {
  ...
  const TICKER_COLOR = [
    "LIVE · VALLEY",
    "FOLDER BECOMES CHANNEL",
    "IF IT PLAYS IT LEADS",
    "JOIN IN PROGRESS",
    "NO ACCOUNT · NO CLOUD",
    "NTSC / VHS LOOK",
    "IR REMOTE · DIGITS TUNE",
    "CHUCKLE · NIGHTFALL · THUNDERBOLT",
    "STARLINE · TOONBOX · PRIME · LOCAL 8",
    "YOUR MEDIA IS THE NEWS",
    "THIS IS YOUR CABLE",
    "PUT ON THE GLASSES",
  ];
  const TICKER_TRUTH = [
    ...
    "STAY LOCAL",
    "SLEEP",
    "YOUR FOLDER IS A CHANNEL",
  ];

  const CHANNELS = [
    {
      num: 3, name: "LOCAL", jump: "#hero",
      shows: [
        { title: "Station Identification", dur: 30, rating: "TV-G",
          desc: "The following program is a local origination. Channel 03, overnight, stereo." },
        { title: "Folder to Channel", dur: 90, rating: "TV-G",
          desc: "Point LocalCable at a media folder. Each subfolder becomes a channel. Files become programs." },
        { title: "Be Kind Rewind", dur: 60, rating: "TV-G",
          desc: "Offline-first on Linux. No account. No cloud. The guide is the product." },
      ],
    },
    {
      ...
      shows: [
        { title: "Horror Mix", dur: 90, rating: "TV-14",
          desc: "Genre cable: movies and episodes mixed onto invented networks. Horror lands on Nightfall." },
